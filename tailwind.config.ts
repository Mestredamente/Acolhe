  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        display: ['SF Pro Display', 'Inter var', 'Inter', 'system-ui', 'sans-serif'],
      },
      colors: {
      ...
      boxShadow: {
        ...
        'modal-strong': '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
      },
      ...
      animation: {
        ...
        'fade-in-300': 'fade-in-300 300ms ease-in-out forwards',
      },
    },
  },
